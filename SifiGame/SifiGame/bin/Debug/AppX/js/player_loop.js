function player_loop() {
    for (playercounter = 0; playercounter < playercollection.count() ; playercounter++) {
        ...
        for (miscobjectcounter = 0; miscobjectcounter < miscobjectcollection.count() ; miscobjectcounter++) {
            ...
            if (collisiondetection1.testcollision(playercollection.array[playercounter], miscobjectcollection.array[miscobjectcounter]) && miscobjectcollection.array[miscobjectcounter].falling == 0 && miscobjectcollection.array[miscobjectcounter].poketointeract == 0/* && playercollection.array[playercounter].type == "player"*/) {

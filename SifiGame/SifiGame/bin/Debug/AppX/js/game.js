function game() {
    ...
    this.loadmap1 = function()
    {
        ...
        platformcollection.add(1200, 370, 300, 30, PLATFORMTYPE_DOOR);
        ...
        platformcollection.add(100, 200, 100, 100, PLATFORMTYPE_DOOR, 15);
        platformcollection.add(380, -300, 300, 30, PLATFORMTYPE_DOOR, 10);
